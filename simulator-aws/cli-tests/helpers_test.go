...
func TestMain(m *testing.M) {
	...
	// one suite's `go build -o` overwrite the binary another is executing the
	// moment they run at the same time.
	binaryPath, _ = filepath.Abs("../.build/cli-tests/simulator-aws")
