...
// Use ASCIIFold for case-insensitive matching that feeds an index, and
// FrameReader for binary wire decoding, instead of raw strings.ToLower +
// binary.BigEndian + slicing.
