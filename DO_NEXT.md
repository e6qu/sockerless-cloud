...
0-iam. **The AWS IAM derivation gap was mostly measurement, and what is left
   is not.** 1,955 of 1,994 on 2026-09-01.
   ...
   The 39 that remain are three shapes, and none of them is ordinary work:
   ...
   - **A resource found only by looking it up.** This is most of what is left.
     ...
     a generation-keyed index instead. Beside it: Systems Manager's access
     request,
