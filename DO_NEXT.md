...
0-iam. **The AWS IAM derivation gap was mostly measurement, and what is left
   is not.** 1,964 of 1,994 on 2026-09-01.
   ...
   The 30 that remain are three shapes, and none of them is ordinary work:
   ...
   - **A resource found only by looking it up.** This is most of what is left.
     ...
     id. Left: Systems Manager's access request, RDS's proxy target group, AWS CloudTrail's insights and query, AWS Auto Scaling's instance health, and Amazon EC2's
