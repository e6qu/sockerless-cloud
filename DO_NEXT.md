...
0-iam. **The AWS IAM derivation gap was mostly measurement, and what is left
   is not.** 1,960 of 1,994 on 2026-09-01.
   ...
   The 34 that remain are three shapes, and none of them is ordinary work:
   ...
   - **A resource found only by looking it up.** This is most of what is left.
     ...
     blocks, each a record keyed by the id the request carries. Left: Systems
     Manager's access request, Amazon RDS's automated backup and proxy target
     group, AWS CloudTrail's insights and query, CloudWatch Logs' query
