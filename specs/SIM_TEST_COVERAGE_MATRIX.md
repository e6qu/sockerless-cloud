...
| `azure-compute_vm_extensions` | direct | direct | tracked (BUG-2952) | `simulator-azure/sdk-tests/compute_network_request_validation_test.go`; `simulator-azure/cli-tests/compute_network_request_validation_test.go` |
| `azure-compute_vm_operations` | direct | direct | tracked (BUG-2952) | `simulator-azure/sdk-tests/compute_network_request_validation_test.go`; `simulator-azure/cli-tests/compute_network_request_validation_test.go` |
| `azure-compute_vm_patches` | direct | direct | tracked (BUG-2952) | `simulator-azure/sdk-tests/compute_network_request_validation_test.go`; `simulator-azure/cli-tests/compute_network_request_validation_test.go` |
