...
|---|---|---|---|---|---|
| `GET /{$}` | ✓ `simulator-aws/s3.go:217::nil` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `PUT /{bucket}` | ✓ `simulator-aws/s3.go:218::s3BucketResource` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /{bucket}` | ✓ `simulator-aws/s3.go:219::s3BucketResource` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /{bucket}` | ✓ `simulator-aws/s3.go:220::s3BucketResource` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `PUT /{bucket}/{key...}` | ✓ `simulator-aws/s3.go:221::s3ObjectResource` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /{bucket}/{key...}` | ✓ `simulator-aws/s3.go:222::s3ObjectResource` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /{bucket}/{key...}` | ✓ `simulator-aws/s3.go:223::s3ObjectResource` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /{bucket}/{key...}` | ✓ `simulator-aws/s3.go:228::s3ObjectResource` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /{bucket}` | ✓ `simulator-aws/s3.go:229::s3BucketResource` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
