...
| `Action AmazonSSM.CreatePatchBaseline` | ✓ `simulator-aws/ssm_patch_baselines.go:55::handleSSMCreatePatchBaseline` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action AmazonSSM.DeletePatchBaseline` | ✓ `simulator-aws/ssm_patch_baselines.go:56::handleSSMDeletePatchBaseline` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action AmazonSSM.GetPatchBaseline` | ✓ `simulator-aws/ssm_patch_baselines.go:57::handleSSMGetPatchBaseline` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action AmazonSSM.UpdatePatchBaseline` | ✓ `simulator-aws/ssm_patch_baselines.go:58::handleSSMUpdatePatchBaseline` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action AmazonSSM.DescribePatchBaselines` | ✓ `simulator-aws/ssm_patch_baselines.go:59::handleSSMDescribePatchBaselines` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action AmazonSSM.GetDefaultPatchBaseline` | ✓ `simulator-aws/ssm_patch_baselines.go:60::handleSSMGetDefaultPatchBaseline` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `Action AmazonSSM.RegisterDefaultPatchBaseline` | ✓ `simulator-aws/ssm_patch_baselines.go:61::handleSSMRegisterDefaultPatchBaseline` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
