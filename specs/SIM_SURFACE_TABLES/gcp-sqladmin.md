...
| `GET /sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures` | 501 `simulator-gcp/sqladmin.go:277::workloadCaptureWhy` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /v1/projects/{project}/instances/{instance}/workloadCaptures` | 501 `simulator-gcp/sqladmin.go:277::workloadCaptureWhy` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures:start` | 501 `simulator-gcp/sqladmin.go:278::workloadCaptureWhy` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /v1/projects/{project}/instances/{instance}/workloadCaptures:start` | 501 `simulator-gcp/sqladmin.go:278::workloadCaptureWhy` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures:stop` | 501 `simulator-gcp/sqladmin.go:279::workloadCaptureWhy` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /v1/projects/{project}/instances/{instance}/workloadCaptures:stop` | 501 `simulator-gcp/sqladmin.go:279::workloadCaptureWhy` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures/{workloadAction}` | 501 `simulator-gcp/sqladmin.go:282::func` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /v1/projects/{project}/instances/{instance}/workloadCaptures/{workloadAction}` | 501 `simulator-gcp/sqladmin.go:282::func` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /sql/v1beta4/projects/{project}/instances/{instance}/releaseSsrsLease` | ✓ `simulator-gcp/sqladmin.go:291::handleSQLReleaseSsrsLease` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /v1/projects/{project}/instances/{instance}/releaseSsrsLease` | ✓ `simulator-gcp/sqladmin.go:291::handleSQLReleaseSsrsLease` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /sql/v1beta4/projects/{project}/instances/{instance}/verifyExternalSyncSettings` | ✓ `simulator-gcp/sqladmin.go:292::handleSQLVerifyExternalSyncSettings` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /v1/projects/{project}/instances/{instance}/verifyExternalSyncSettings` | ✓ `simulator-gcp/sqladmin.go:292::handleSQLVerifyExternalSyncSettings` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /sql/v1beta4/projects/{project}/backups` | ✓ `simulator-gcp/sqladmin.go:300::handleSQLCreateBackup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /v1/projects/{project}/backups` | ✓ `simulator-gcp/sqladmin.go:300::handleSQLCreateBackup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /sql/v1beta4/projects/{project}/backups` | ✓ `simulator-gcp/sqladmin.go:301::handleSQLListBackups` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /v1/projects/{project}/backups` | ✓ `simulator-gcp/sqladmin.go:301::handleSQLListBackups` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /sql/v1beta4/projects/{project}/backups/{backup}` | ✓ `simulator-gcp/sqladmin.go:302::handleSQLGetBackup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /v1/projects/{project}/backups/{backup}` | ✓ `simulator-gcp/sqladmin.go:302::handleSQLGetBackup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `PATCH /sql/v1beta4/projects/{project}/backups/{backup}` | ✓ `simulator-gcp/sqladmin.go:303::handleSQLUpdateBackup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `PATCH /v1/projects/{project}/backups/{backup}` | ✓ `simulator-gcp/sqladmin.go:303::handleSQLUpdateBackup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /sql/v1beta4/projects/{project}/backups/{backup}` | ✓ `simulator-gcp/sqladmin.go:304::handleSQLDeleteBackup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `DELETE /v1/projects/{project}/backups/{backup}` | ✓ `simulator-gcp/sqladmin.go:304::handleSQLDeleteBackup` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /sql/v1beta4/projects/{project}/operations/{operation}` | ✓ `simulator-gcp/sqladmin.go:306::handleSQLGetOperation` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /v1/projects/{project}/operations/{operation}` | ✓ `simulator-gcp/sqladmin.go:306::handleSQLGetOperation` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /sql/v1beta4/projects/{project}/operations` | ✓ `simulator-gcp/sqladmin.go:307::handleSQLListOperations` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /v1/projects/{project}/operations` | ✓ `simulator-gcp/sqladmin.go:307::handleSQLListOperations` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /sql/v1beta4/projects/{project}/operations/{operation}/cancel` | ✓ `simulator-gcp/sqladmin.go:308::handleSQLCancelOperation` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `POST /v1/projects/{project}/operations/{operation}/cancel` | ✓ `simulator-gcp/sqladmin.go:308::handleSQLCancelOperation` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /sql/v1beta4/projects/{project}/tiers` | ○ `simulator-gcp/sqladmin.go:310::handleSQLListTiers` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /v1/projects/{project}/tiers` | ○ `simulator-gcp/sqladmin.go:310::handleSQLListTiers` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /sql/v1beta4/flags` | ○ `simulator-gcp/sqladmin.go:311::handleSQLListFlags` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
| `GET /v1/flags` | ○ `simulator-gcp/sqladmin.go:311::handleSQLListFlags` | ✓ (direct; see coverage matrix) | ✓ (direct; see coverage matrix) | n/a | |
